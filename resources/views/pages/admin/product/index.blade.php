...
<section class="max-w-screen-xl px-4 py-8 mx-auto sm:px-6 sm:py-12 lg:px-8">
  <div class="border border-gray-200 rounded-lg">
      ...
      <table class="min-w-full text-sm bg-white divide-y-2 divide-gray-200">
        ...
        <tbody class="divide-y divide-gray-200">
          ...
          <tr>
            ...
            <td class="px-4 py-2 text-center text-gray-700 whitespace-nowrap">Rp{{ number_format($product->price, 2) }}</td>
    ...
    <div class="flex justify-center px-4 py-2 border-t border-gray-200 rounded-b-lg">
      {{ $products->links('vendor.pagination.custom', ['products' => $products]) }}
    </div>
  </div>
</section>
