<div class="flex pt-16 overflow-hidden lg:pt-4 xl:pt-12 max-lg:flex-col-reverse sm:items-center">
  <div class="p-8 md:p-12 lg:px-16 lg:py-24">
    <div class="max-w-xl mx-auto text-center">
      ...
      <div class="mt-4 md:mt-8">
        <a
          href="#"
          class="inline-block px-12 py-3 text-sm font-medium text-white transition bg-slate-600 hover:bg-slate-700 focus:outline-none focus:ring focus:ring-yellow-400"
        >
  ...
  <img
    ...
    class="object-cover w-full h-full min-h-[400px] lg:max-h-[400px]"
  />
</div>